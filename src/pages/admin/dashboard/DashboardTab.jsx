            ...
            <div className="container mx-auto">
                <div className="tab container mx-auto ">
                    <Tabs defaultIndex={0} className=" " >
                        <TabList className="md:flex flex-wrap md:space-8  grid grid-cols-3 grid-flow-col  text-center gap-4   md:justify-center mb-10 ">
                            <Tab>
                            ...
                            <Tab>
                                <button type="button" className="font-medium border-b-2 border-green-500 bg-[#605d5d12] text-green-500 rounded-lg text-xl  hover:shadow-green-700 shadow-[inset_0_0_8px_rgba(0,0,0,0.6)]   px-5 py-1.5 text-center ">
                                    <div className="flex gap-2 md:gap-0 items-center md:items-center">
                                        <FaUser /> Users
                                    </div>
                                </button>
                            </Tab>
                                ...
                                <div className="relative overflow-x-auto ">
                                    <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400  ">
                                        ...
                                        {product.map((item, index) => {
                                            ...
                                            return (
                                                <tbody key={item.id || index} className=''>
                        ...
                        <TabPanel>
                            ...
                            <div className="relative overflow-x-auto mb-16">
                                ...
                                {order.map((allorder,index)=>{
                                    return(
                                    <table key={allorder.id || index} className="w-full text-sm text-left text-gray-500 dark:text-gray-400" >
